...
singularity exec --nv ${SINGULARITY_CONTAINER} python3 src/main.py --mode all --run-name regen-exp-09-epochs-30 --num-nodes 100 --epochs 30 --curriculum 9 --regen --val-set tsp-100-val-1000.npy &
